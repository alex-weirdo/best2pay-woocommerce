...
function init_woocommerce_best2pay() {
	if ( ! class_exists( 'AS_UPDATER' ) ) {
		include( __DIR__ . '/classes/updater.php' );
	}
	if ( class_exists(AS_UPDATER::class) ) {
		$TARGET_DIR = __DIR__;
		new AS_UPDATER($TARGET_DIR);
	}
	...
	class woocommerce_best2pay extends WC_Payment_Gateway {
		...
		*/
		...
		public function process_payment( $order_id ) {
            ...
            $signature  = base64_encode(md5($this->sector . intval($order->order_total * 100) . $currency . $this->password));
